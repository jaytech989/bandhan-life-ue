export default function decorate(block) {
  ...
  divEl7.setAttribute('class', 'cards-with-paragraph');
    ...
    pEl2.textContent = 'iInvest Advantage';
    divEl11.append(pEl2);
    ...
    divEl12.textContent = 'Super Flexible. High Performance.';
  ...
  divEl31.textContent = 'Pay Premium';
